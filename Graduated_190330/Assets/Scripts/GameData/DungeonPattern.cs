...
public class DungeonPattern
{
    ...
    public DungeonPattern(int id, string enemyName, int enemyHealth, string prefabPath,List<EnemyPattern> patternList, string patternDescription, float patternTerm)
    {
        this.Id = id;
