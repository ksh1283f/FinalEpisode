...
public class UserManager : Singletone<UserManager> {
    ...
    public void SetPropertyInUserInfo (E_PropertyEffectType propertyType) {
        if (UserInfo == null)
            return;

        E_BattlePropertyType battlePropertyType = propertyType.GetBattlePropertyType ();
        switch (battlePropertyType) {
            ...
            case E_BattlePropertyType.Common:
                UserInfo.CommonPropertyType = propertyType;
                break;

            case E_BattlePropertyType.Util:
                UserInfo.UtilPropertyType = propertyType;
                break;

            case E_BattlePropertyType.Healing:
                UserInfo.HealingPropertyType = propertyType;
                break;
        }
